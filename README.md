...
知遇借鉴 Date Drop 的深度匹配算法理念，将其应用于招聘场景：
...
知遇的核心技术差异化在于引入 [LightRAG](https://github.com/HKUDS/LightRAG)（港大 HKUDS，EMNLP 2025）作为匹配引擎的 **Layer 0 — 上下文理解层**。它不替代匹配算法本身，而是让算法真正"读懂"非结构化信息。
...
运行 `./scripts/seed-db.sh` 后，可使用种子数据中的用户登录体验完整流程。
